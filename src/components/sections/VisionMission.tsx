      ...
      >
        ...
        >
          ...
          <p className="mt-6 max-w-[520px] text-[16px] leading-[1.8] text-white/80 sm:mt-8 sm:text-[24px] lg:mt-10 lg:text-[28px]">
            {isArabic
              ? "أن نكون الخيار الأول للمستثمرين العرب والدوليين الراغبين في دخول السوق السعودي، من خلال بناء سمعة ترتكز على الثقة، والشفافية، وتحقيق النتائج."
        ...
        >
          ...
          >
            ...
            <p className="mt-6 max-w-[520px] text-[15px] leading-[1.9] text-white/70 sm:mt-8 sm:text-[21px] lg:text-[24px]">
              {isArabic
                ? "نؤمن بأن كل مستثمر يستحق شريكًا يعتمد عليه، يرافقه في كل خطوة، ويقدم له المعلومات الدقيقة، ويحمي مصالحه، ويلتزم بتنفيذ كل ما يعد به في الوقت المحدد."
